...
export default function Team(){
    ...
    return (
        ...
        <div className='flex flex-col md:flex-row justify-around xl:mt-3 p-2'>
            {members.map((member) => (
                <div key={member.key} className='p-2 flex flex-col items-center border m-2 rounded-lg shadow-lg shadow-green-500'>
        ...
        <h2 className="subtitle subtitleMain mt-5">{text.subtitle}</h2>
        </section>
    );
};