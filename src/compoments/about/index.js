    ...
    return(
        <section className='py-4 bg-gray-100 lg:h-screen'>
            ...
            <div className='m-10 flex justify-around items-center flex-col lg:flex-row p-2'>
                <img src={robots} className='h-96 w-auto lg:h-80  rounded-lg mb-3 shadow-lg shadow-green-200 xl:transform xl:scale-80 xl:-rotate-6 hover:-rotate-0' alt='robots'/>
